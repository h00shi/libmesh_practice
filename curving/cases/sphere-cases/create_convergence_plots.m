...
# lagrange
[N,res] = append_file('sphere_l_o2.pp');
semilogy(N, res, 'b-;Lagrange;', 'linewidth', 2);

# hie
[N,res] = append_file('sphere_h_o2.pp');
semilogy(N, res, 'r-;Hierarchic;', 'linewidth', 2);

# bern
[N,res] = append_file('sphere_b_o2.pp');
...
# hie
[N,res] = append_file('sphere_h_o3.pp');
semilogy(N, res, 'r-;Hierarchic;', 'linewidth', 2);

# bern
[N,res] = append_file('sphere_b_o3.pp');
semilogy(N, res, 'm-;Bernstein;', 'linewidth', 2);
